...
subtitle: "Due by 11:59 p.m., Friday September 16"
toc: true
editor: source
execute: 
  enabled: true
...
6.  Which is the most dangerous month? Let's create a new dataframe that groups accidents by month then create a line graph to visualize the data. Try writing the code yourself this time. (HINT: the code is *nearly* identical to the three codeblocks above).
