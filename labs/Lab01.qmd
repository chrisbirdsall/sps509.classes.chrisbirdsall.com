...
You're done with the data analysis exercises, now it's time to render!

## Rendering an HTML file

Click the "Render" button at the top left side of the screen to render the file, or in other words, produce an output document. An `.html` file will be generated.
...
Click on the gear icon in on top of the R Markdown document, and select "Output Options..." in the dropdown menu. In the pop up dialogue box go to the Figures tab and change the height and width of the figures, and hit OK when done. Then, render your document and see how you like the new sizes. Change and render again and again until you're happy with the figure sizes. Note that these values get saved in the YAML.
...
Once again click on the gear icon in on top of the R Markdown document, and select "Output Options..." in the dropdown menu. In the General tab of the pop up dialogue box try out different Syntax highlighting and theme options. Hit OK and render your document to see how it looks. Play around with these until you're happy with the look.
