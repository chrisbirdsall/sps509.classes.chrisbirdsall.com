...
An additional goal is to introduce you to git and GitHub, which is the collaboration and version control system that we will use moving forward. Github is extremely helpful for tracking down problems with your code and for managing collaboration, which we'll do in some labs later in the semester.

::: column-margin
git is a version control system (like "Track Changes" features from Microsoft Word) and GitHub is the home for your Git-based projects on the internet.
:::
...
Visit [RStudio.cloud](https://rstudio.cloud/) and login using the credentials you setup in our first class. Once you load up RStudio Cloud in your web browser you should see something like this:
...
2.  Plot `y` vs. `x` for the `dino` dataset. Then, calculate the correlation coefficient between `x` and `y` for this dataset. (Er... excuse me?)
...
![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%252Fapp%252FBirdsall%252F6ITdw9RsRz.png?alt=media&token=74bb917e-a08a-4f90-afce-5cf0a9df34e2)

Then click on the html file in the "Files" pane to open it in your web browser:

![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%252Fapp%252FBirdsall%252FOyw3gwXuhI.png?alt=media&token=4bdbfa5e-3218-45fe-8f2d-cdd3beb605de)
...
4.  Go to our class page on canvas and click on "assignments". Navigate to "Lab 01" and submit just as you would a paper in any other class.
