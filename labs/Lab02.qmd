...
First, open the R Markdown document starter document,`lab-02.Rmd`, enter your name and date in the YAML header, rename the file and Knit it. Make sure it compiles without errors. The output will be in the file markdown `.html` file with the same name, which you will submit on Canvas once you're done.
