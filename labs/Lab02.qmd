...
First, open the R Markdown document starter document,`lab-02.Rmd`, enter your name and date in the YAML header, rename the file and Knit it.
Make sure it compiles without errors.
The output will be in the file markdown `.html` file with the same name, which you will submit on Canvas once you're done. 
...
The dataset for this assignment can be found as a csv file in the `data` folder in the files pane. 
...
::: column-margin
**Hint:** The lab is asking you to run code that's not required for answering the exercises below. However, it's generally good to copy and run this code yourself in your rmarkdown file. Just copy the code over to a new code block (similar to how I describe in the "How to read Moderndive" video.)
...
::: column-margin
**NOTE:** Moving forward, the plots and the output of the code are not displayed in the lab instructions, but you can and should copy the code to your R Markdown file and view the results yourself.
:::
...
The `alpha` argument takes values between 0 and 1 (e.g., 0.5): 0 is completely transparent and 1 is completely opaque.
