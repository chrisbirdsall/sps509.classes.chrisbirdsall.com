...
```{r, eval=FALSE}
score_model_2 <- lm(score ~ age + gender, 
                    data = evals_multiple)
...
\hline
\textbf{term}       & \textbf{estimate} & \textbf{std\_error} & \textbf{statistic} & \textbf{p\_value} & \textbf{lower\_ci} & \textbf{upper\_ci} \\ \hline
intercept  & 4.484    & 0.125      & 35.79     & 0.000    & 4.238     & 4.730     \\ \hline
age        & -0.009   & 0.003      & -3.28     & 0.001    & -0.014    & -0.003    \\ \hline
gendermale & 0.191    & 0.052      & 3.63      & 0.000    & 0.087     & 0.294     \\ \hline
\end{tabular}%
}
\end{table}
